...
public class PatientWorkAreaJFrame extends javax.swing.JFrame {
     ...
     */
    public PatientWorkAreaJFrame(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise) {
        initComponents();
        setSize(1370, 725);
    ...
    private void initComponents() {
        ...
        jMenu1.setText("Personal Profile");
        jMenuBar1.add(jMenu1);

        jMenu2.setText("Vital Sign Profile");
        jMenuBar1.add(jMenu2);

        jMenu3.setText("Diet Regime");
        jMenuBar1.add(jMenu3);

        jMenu4.setText("Exercise Regime");
        jMenuBar1.add(jMenu4);

        jMenu5.setText("Medical Profile");
